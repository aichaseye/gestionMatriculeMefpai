...
export class ClasseComponent implements OnInit {
  ...
  constructor(protected classeService: ClasseService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.classes = [];
    ...
    this.classeService
      ...
      .subscribe({
        next: (res: HttpResponse<IClasse[]>) => {
          ...
          this.paginateClasses(res.body, res.headers);
        },
        error: () => {
          this.isLoading = false;
        },
  ...
  protected paginateClasses(data: IClasse[] | null, headers: HttpHeaders): void {
