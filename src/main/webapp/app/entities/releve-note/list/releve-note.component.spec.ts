...
describe('ReleveNote Management Component', () => {
  let comp: ReleveNoteComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(ReleveNoteComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.releveNotes[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
