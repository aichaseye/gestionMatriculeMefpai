...
class RegionResourceIT {
    ...
    private static final NomRegion DEFAULT_NOM_REG = NomRegion.Dakar;
    private static final NomRegion UPDATED_NOM_REG = NomRegion.Thies;
    ...
    public static Region createEntity(EntityManager em) {
        Region region = new Region().nomReg(DEFAULT_NOM_REG);
        return region;
    }
    ...
    public static Region createUpdatedEntity(EntityManager em) {
        Region region = new Region().nomReg(UPDATED_NOM_REG);
        return region;
    }
    ...
    void createRegion() throws Exception {
        ...
        assertThat(testRegion.getNomReg()).isEqualTo(DEFAULT_NOM_REG);
    }
    ...
    @Test
    @Transactional
    void checkNomRegIsRequired() throws Exception {
        int databaseSizeBeforeTest = regionRepository.findAll().size();
        // set the field null
        region.setNomReg(null);
    ...
    void getAllRegions() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.[*].nomReg").value(hasItem(DEFAULT_NOM_REG.toString())));
    }
    ...
    void getRegion() throws Exception {
        ...
        restRegionMockMvc
            ...
            .andExpect(jsonPath("$.nomReg").value(DEFAULT_NOM_REG.toString()));
    }
    ...
    void putNewRegion() throws Exception {
        ...
        updatedRegion.nomReg(UPDATED_NOM_REG);
        ...
        Region testRegion = regionList.get(regionList.size() - 1);
        assertThat(testRegion.getNomReg()).isEqualTo(UPDATED_NOM_REG);
    }
    ...
    void partialUpdateRegionWithPatch() throws Exception {
        ...
        partialUpdatedRegion.nomReg(UPDATED_NOM_REG);
