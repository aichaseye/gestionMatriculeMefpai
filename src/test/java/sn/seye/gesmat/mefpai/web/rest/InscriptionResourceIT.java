...
class InscriptionResourceIT {
    ...
    public static Inscription createEntity(EntityManager em) {
        Inscription inscription = new Inscription().anneeIns(DEFAULT_ANNEE_INS);
        return inscription;
    }
    ...
    public static Inscription createUpdatedEntity(EntityManager em) {
        Inscription inscription = new Inscription().anneeIns(UPDATED_ANNEE_INS);
        return inscription;
    }
    ...
    void putNewInscription() throws Exception {
        ...
        updatedInscription.anneeIns(UPDATED_ANNEE_INS);
